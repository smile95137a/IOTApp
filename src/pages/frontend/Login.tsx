...
import logo from '@/assets/image/i-Pool_logo_RGB_1.png';
...
const Login: React.FC = () => {
  ...
  const [loginType, setLoginType] = useState<'phone' | 'email'>(
    (location.state?.loginType as 'phone' | 'email') || 'phone'
  );
          ...
          <div className="login__main">
            <form className="login__form" onSubmit={handleSubmit(onSubmit)}>
              <div className="login__auth">
                ...
                >
                  <div className="login__auth-btn-icon"></div>
            ...
            <div className="login__other">
              ...
              <div className="login__other-info">
                <p className="login__text">歡迎來到 官方網站!</p>
