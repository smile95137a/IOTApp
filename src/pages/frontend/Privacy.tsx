    ...
    <div className="privacy">
      <div className="privacy__item">
        <div className="privacy__item-title">
          <p className="privacy__text">隱私權政策</p>
        </div>
        <div className="privacy__item-main">
          <p className="privacy__text">
            關於個人資料保護，請參閱以下網站的隱私權聲明(以下簡稱本網站)
          </p>
          <p className="privacy__text">
            為了支持個人資料保護，維護個人隱私權，本網站謹以下列聲明，向您說明本網站蒐集個人資料之目的、類別、利用範圍及方式、以及您所得行使之權利等事項；
          </p>
          <p className="privacy__text">
            如果您對於本網站的隱私權聲明、以下相關告知事項、或與個人資料保護有關之相關事項有任何疑問，可以和官方賴客服聯絡，將儘快回覆說明。
          </p>
        </div>
      </div>
      ...
      <div className="privacy__item">
        ...
        <div className="privacy__item-main">
          <p className="privacy__text">
            2.1
            我們僅會在提供商品銷售、金融交易授權、物流配送、贈獎活動、會員權益通知、或其他附隨以上各樣服務及其他「網站」未來所有可能衍生之及相關服務時，為作業之必要運用您的個人資料：
            •物流寄送：我們會於提供客戶商品銷售、物流配送等履行訂單之服務，提供配送資料予合作廠商及物流商。
            金融交易授權：您所提供之基本資料、帳務資料及其他必要資料，將於金融交易過程(包含信用卡授權)中，提供予金融機構以完成金融交易及相關業務。
            •其他業務附隨事項：依據以上所述服務目的、贈獎活動、會員相關權益通知，及您在使用「」其他服務，有同意之前提下，於必要範圍內進行相關運用。
          </p>
          <p className="privacy__text">
            2.2
      ...
      <div className="privacy__item">
        ...
        <div className="privacy__item-main">
          <p className="privacy__text">
            ...
            2.
            為使相關服務得以順利提供或使相關交易得以順利完成並履行完畢，若您不願意提供各該服務或交易所要求的相關個人資料予「」，並同意本網站就該等個人資料依法令規定以及本隱私權相關內容聲明，「」將尊重您的決定，但依照各該服務之性質或條件，您可能因此無法使用該等服務或完成相關交易。
          </p>
        </div>
      </div>
