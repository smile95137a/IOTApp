  ...
  <div class="store-page">
    <div class="store-page__container">
      ...
      >
        ...
        <div class="store-card__table-count store-card__table-count--yellow">
          <div class="label">剩餘桌數</div>
          <div class="count">{{ store.poolTables.length }}</div>
          <div class="arrow">
...
const goToDetail = (uid: string) => {
  router.push({ name: 'BookStoreDetail', params: { id: uid } });
};
